$(function() {
	...
	Property.displayContent = function() {
		...
		$('table').stupidtable();////stupidTable sort
	};

	//create properties

	var property1 = new Property("2345 Fairview Ln.", "Brooklyn", "NY", 1200000, "2015 Apr 30");
	var property2 = new Property("974 Clapton St.", "Queens", "NY", 998000, "2015 May 1");
	var property3 = new Property("14A Belmont Way", "Bronx", "NY", 874000, "2015 Mar 28");
	var property4 = new Property("1455 Crazy Lane", "Queens", "NY", 555000, "2014 Mar 28");
